...
/// <summary>
/// Action filter that enforces idempotency for POST endpoints that create transactions or modify balances.
...
public class IdempotencyFilterAttribute : Attribute, IAsyncActionFilter
{
    ...
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        var dbContext = httpContext.RequestServices.GetRequiredService<TransactionDbContext>();
    ...
    private static async Task CleanupExpiredRecordsAsync(TransactionDbContext dbContext, ILogger logger)
    {
        try
        {
